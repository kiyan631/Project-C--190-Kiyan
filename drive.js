        ...
        window.addEventListener('keydown' ,function(e) {
            ...
            if(e.code == "ArrowUp") {
                ...
                if(multiply <= 100 && cameraPosition.z > -500){
                    cameraRig.setAttribute("movement-controls",{"speed" : cameraMmoveControl.speed + 0.005})
